...
export default function ResumeBuilder() {
    ...
    if (file) {
      ...
      setTimeout(() => {
        ...
        setAiSuggestions({
          ...
          experience: ["Replace 'Led development' with a stronger action verb like 'Architected' or 'Spearheaded'"],
          skills: ["Add 'Next.js' to your skills based on your experience with React"],
        })
      }, 2000)
    }
  }
  ...
  const acceptSummarySuggestion = () => {
    setResumeData({
      ...resumeData,
      summary:
        resumeData.summary + " Increased application performance by 40% and reduced infrastructure costs by 25%.",
    })
    ...
    if (resumeData.jobTitle) {
      ...
      setTimeout(() => {
        ...
        setResumeData({
          ...
          skills: ["JavaScript", "React", "Node.js", "Problem Solving", "Team Leadership"],
        })
        // Set AI suggestions
        setAiSuggestions({
          summary: "Consider adding specific metrics or achievements to make your summary more impactful.",
          experience: ["Add specific projects or quantifiable achievements to your experience description."],
          skills: ["Consider adding more specific technical skills relevant to your role."],
        })
      }, 2000)
    }
  }
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-6">
                  Upload your existing resume and our AI will extract the information and suggest improvements.
                </p>

                <div className="border-2 border-dashed rounded-lg p-8 text-center mb-6">
                  <Upload className="h-10 w-10 mx-auto mb-4 text-muted-foreground" />
                  <p className="mb-2">Drag and drop your resume here</p>
                  <p className="text-sm text-muted-foreground mb-4">Supports PDF and DOCX formats</p>
                ...
                {currentStep === 1 && (
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-end">
                      <Button onClick={nextStep} disabled={!resumeData.jobTitle}>
                        Next
                          ...
                          {aiSuggestions.experience[0] && index === 0 && (
                            <div className="p-3 bg-muted rounded-md border border-border">
                              <div className="flex items-start gap-2">
                                ...
                                <div className="flex-grow">
                                  <p className="text-sm font-medium">AI Suggestion:</p>
                                  <p className="text-sm">{aiSuggestions.experience[0]}</p>
                                  <div className="flex gap-2 mt-2">
                                    <Button size="sm" variant="outline" className="h-7 text-xs">
                                      <CheckCircle className="h-3 w-3 mr-1" />
                                      Accept
                      ...
                      {aiSuggestions.skills[0] && (
                        <div className="p-3 bg-muted rounded-md border border-border">
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-grow">
                              <p className="text-sm font-medium">AI Suggestion:</p>
                              <p className="text-sm">{aiSuggestions.skills[0]}</p>
                              <div className="flex gap-2 mt-2">
                                <Button size="sm" variant="outline" className="h-7 text-xs">
                                  <CheckCircle className="h-3 w-3 mr-1" />
                                  Accept
                ...
                <div className="border rounded-lg p-6">
                  {resumeData.jobTitle ? (
                    ...
                    <div className="text-center py-8 text-muted-foreground">
                      ...
                      <p className="text-sm">Start by entering your job title in step 1</p>
                    </div>
                  )}
                </div>
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm">
                          ...
                          {currentStep === 4 && "Great skills list! Consider organizing them by proficiency level."}
                        </p>
                      </div>
                    </div>
                  </div>
